...
@interface GTWKCustomProtocol()
@property(nonatomic, strong) NSURLSessionDataTask *dataTask;
@end

@implementation GTWKCustomProtocol
...
- (NSString *)_getWebViewReuseLoadString{
    return @"<html><head><meta name=\"viewport\" " @"content=\"initial-scale=1.0,width=device-width,user-scalable=no\"/><title>GTWKWebKit-Reuse</title></head><body></body></html>";
}
